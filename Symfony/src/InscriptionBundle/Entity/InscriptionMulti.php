 ...
 * InscriptionMulti
 *
 * @ORM\Table(name="inscription_multi")
 * @ORM\Entity(repositoryClass="InscriptionBundle\Repository\InscriptionMultiRepository")
 */
class InscriptionMulti
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="captain_user", type="string", length=255, nullable=true)
     */
    private $captainUser;
    ...
    /**
     * @param string $captainUser
     */
    public function setCaptainUser($captainUser)
    {
